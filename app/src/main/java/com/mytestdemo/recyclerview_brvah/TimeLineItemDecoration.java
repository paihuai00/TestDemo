...
public class TimeLineItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public TimeLineItemDecoration(Context context, int radius) {
                ...
                if (childPosition != RecyclerView.NO_POSITION) {
                    if (baseQuickAdapter.getHeaderLayoutCount() != 0) {
                        if (childPosition != 0) {
                            ...
                            } else if (childPosition == baseQuickAdapter.getItemCount() - 1) {
                                //画最后一个
    ...
    private void drawLastTimeLine(Canvas canvas, RecyclerView parent, View view) {
        ...
        float verticalEndY = verticalStartY + mPadding + mBigCircleRadius / 2.0f;
